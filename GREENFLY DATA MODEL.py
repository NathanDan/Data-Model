...
def Funct_LOGIN():
    ...
    Scroll="\n"*70
    print(Scroll)
    print("Please enter your username and password to gain access to the program")
    print(" ")
    username = input("Enter your username: ")
    password = getpass.getpass(prompt='Please enter your password: ')
    Funct_CheckPass(username, password)

def Funct_CheckPass(use, pwd):

    if use == "Admin" and pwd == "Develop01":
        Scroll="\n"*70
        print(Scroll)
        Funct_Login(use)
...
def Funct_Login(use):
    ...
    print(" ")
    print("Welcome to your GREENFLY Data Model! ")
    print(" ")
    Funct_MENU()
